...
{{--    <div class="container-fluid">--}}
    <!--Benefits  -->
            ...
            <div class="ac-center box">
                ...
                <div class="ac">
                    ...
                    @if($latest['sale_price']>0)
                        <div class="price">
                            <strike style="color: #761b18;">Rs. {{$latest['price']}}</strike>
                            <span style="color: #2d995b">Rs. {{$latest['sale_price']}}</span>
                        </div>
                        <a href="{{route('products.productshop')}}" class="btn btn-outline-success">ORDER NOW</a>
                    @else
                        <div class="price">Rs. {{$latest['price']}}</div>
                        <a href="{{route('products.productshop')}}" class="btn btn-outline-success">ORDER NOW</a>
                    @endif
                </div>
                @endforeach
        ...
        <section class="sections">
            ...
            <div class="ab box">
                <div class="item item-1">
                        ...
                        <p>{{$categories->toArray()[0]['cat_name']}}</p>
                </div>
        ...
        <section class="sections">
            ...
            <div class="ac-center box">
                ...
                <div class="ac">
                    ...
                    @if($product['sale_price']>0)
                        <div class="price">
                            <strike style="color: #761b18;">Rs. {{$product['price']}}</strike>
                            <span style="color: #2d995b">Rs. {{$product['sale_price']}}</span>
                        </div>
                        <a href="{{route('products.productshop')}}" class="btn btn-outline-success">ORDER NOW</a>
                    @else
            ...
            <!--  admin section ko lagi only seen by admin  -->
