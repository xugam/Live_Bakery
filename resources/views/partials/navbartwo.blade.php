...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <img src="uploads/other/logo.png" alt="Company Logo" style="width: 100px; height: auto;">    
    <a class="navbar-brand" href="/"><i class="blog-header-logo text-dark"><span class="and"><span style="color: #ff4321;">Live</span> Bakery</span></i></a>
