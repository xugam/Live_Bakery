...
//            'phone_number'=>trim($request->input('phone_number')),
            'phone_number'=>'+977'. '-' .trim($request->input('phone_number')),
            'password'=>bcrypt($request->input('password')),
            'email_verification_token'=> uniqid(now('Asia/Nepal').$request->input('email'),true).Str::random(40)
